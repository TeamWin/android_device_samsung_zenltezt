...
TARGET_PREBUILT_KERNEL := device/samsung/zenltezt/Image
TARGET_PREBUILT_DTB := device/samsung/zenltezt/dtb.img
...
BOARD_CUSTOM_BOOTIMG_MK :=  device/samsung/zenltezt/bootimg.mk
...
TARGET_LIBINIT_DEFINES_FILE := device/samsung/zenltezt/init/init_zenltezt.cpp
